...
Welcome to the complete module breakdown. This curriculum takes you from basic **sensor logic** to building a fully autonomous humanoid robot brain.

:::info 🎓 Quarter Goal
**From Zero to Autonomous:** By the end of Module 7, you will have a simulated robot capable of understanding voice commands and manipulating objects in a 3D environment.
:::
...
| :--- | :--- | :--- |
| **01** | Intro to Physical AI | Sensors & Embodied Intelligence |
| **02** | The Robotic Nervous System | ROS 2, Nodes, Topics, Services |
| **03** | The Digital Twin | Gazebo Physics & Unity |
| **04** | The AI-Robot Brain | NVIDIA Isaac Sim & Nav2 |
| **05** | Humanoid Development | Walking, Balance, Grasping |
| **06** | Vision-Language-Action | OpenAI Whisper, LLMs for Control |
| **07** | Capstone Project | Final Integration & Autonomous Humanoid |
